...
DROP TABLE IF EXISTS PROD_FOURNI;/*Enes*/

DROP TABLE IF EXISTS PARAMETRE;/*Enes*/

DROP TABLE IF EXISTS IMG_PROD;/*Genc*/

DROP TABLE IF EXISTS FAVORI;/*Mohamed*/

DROP TABLE IF EXISTS AVIS;/*Mohamed*/

DROP TABLE IF EXISTS FOURNISSEUR;/*Mohamed*/

DROP TABLE IF EXISTS COMMANDE_PROD;/*Genc*/

DROP TABLE IF EXISTS COMMANDE;/*Enes*/

DROP TABLE IF EXISTS CLIENT;/*Mohamed*/

DROP TABLE IF EXISTS PRODUIT;/*Enes*/

DROP TABLE IF EXISTS CATEGORIE_PROD;/*Genc*/

DROP TABLE IF EXISTS TYPE_PROD;/*Genc*/
